...
class BinaryWorkbenchOffsetRegionsDialog(OffsetRegionsRowsMixin, QDialog):
    ...
    def _build_entry(self, parent: QVBoxLayout) -> None:
        ...
        self.name = lba_input(BINARY_WORKBENCH_TEXT.OFFSET_NAME, entry, width=OFFSET_REGIONS_SIZE.FIELD_WIDTH)
        self.offset = lba_input(BINARY_WORKBENCH_TEXT.OFFSET_VALUE, entry, width=OFFSET_REGIONS_SIZE.FIELD_WIDTH)
        set_hex_value_validator(self.offset)
        configure_binary_workbench_input(self.name, OFFSET_REGIONS_SIZE.FIELD_WIDTH)
        configure_binary_workbench_input(self.offset, OFFSET_REGIONS_SIZE.FIELD_WIDTH)
        configure_binary_workbench_line_edit(self.name, OFFSET_REGIONS_SIZE.FIELD_WIDTH)
        configure_binary_workbench_line_edit(self.offset, OFFSET_REGIONS_SIZE.FIELD_WIDTH)
