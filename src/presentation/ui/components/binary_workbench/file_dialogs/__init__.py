from src.presentation.ui.components.binary_workbench.file_dialogs.internal_file_dialog import (
...
from src.presentation.ui.components.binary_workbench.file_dialogs.version_change_dialog import (
